...
export default interface IServiceCollection {
    ...
    RegisterInstanceV2<INTERFACE, INTERFACEINFO extends InterfaceInfoConstructor<INTERFACE>, INSTANCE extends INTERFACE>(interfaceInfoType: INTERFACEINFO, instance: INSTANCE): void;
    ...
    RegisterV2<INTERFACE, INTERFACEINFO extends InterfaceInfoConstructor<INTERFACE>, CLASS extends INTERFACE>(serviceType: ServiceType, interfaceInfoType: INTERFACEINFO, serviceConstructor: ServiceConstructor<CLASS>, serviceConstructorParameters?: (serviceProvider: IServiceProvider) => any[]): void;
    ...
    RegisterTypedParametersV2<INTERFACE, INTERFACEINFO extends InterfaceInfoConstructor<INTERFACE>, CLASS extends INTERFACE, PARAMETERS>(serviceType: ServiceType, interfaceInfoType: INTERFACEINFO, serviceConstructor: ServiceConstructorTypedParameters<CLASS, PARAMETERS>, serviceConstructorParameters: (serviceProvider: IServiceProvider) => PARAMETERS): void;
